...
""" For testing insertion in db with mock data """
...
class ProductFactory(factory.django.DjangoModelFactory):
    ...
    is_active = True
    created_at = "2021-09-04 22:14:18"
    updated_at = "2021-09-04 22:14:18"

    """ 
    Assign the categories to the product from new_product = product_factory.create(category=(1, 36))
    """
