...
"""
Using Factories to test new entries in the test DB
Using Fixtures to test existing/loaded entries in the test DB
"""
...
def test_inventory_db_product_web_id_uniqueness_integrity(db, product_factory):  # using mock data
...
def test_inventory_db_producttype_inserts_data(db, product_type_factory):
