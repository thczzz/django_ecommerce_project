...
class Product(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("date product was created"),
...
class ProductInventory(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("date sub-product was created"),
        help_text=_("format: Y-m-d H:M:S")
    )
    updated_at = models.DateTimeField(
        auto_now=True,
...
class Media(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("date image was created"),
        help_text=_("format: Y-m-d H:M:S")
    )
    updated_at = models.DateTimeField(
        auto_now=True,
...
class Stock(models.Model):
    ...
    units = models.IntegerField(
        default=0,
        verbose_name=_("units/quantity of stock"),
        help_text=_("format: required, default-0")
    )
    units_sold = models.IntegerField(
        default=0,
        verbose_name=_("units/quantity sold to date"),
        help_text=_("format: required, default-0")
    )
