# Generated by Django 4.0.2 on 2022-03-13 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99'}}, help_text='format: max price 9999.99', max_digits=6, verbose_name='recommended store price')),
                ('sale_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99'}}, help_text='format: max price 9999.99', max_digits=6, verbose_name='recommended sale price')),
