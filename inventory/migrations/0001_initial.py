# Generated by Django 4.0.2 on 2022-02-19 22:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='format: required, unique, max_length-255', max_length=255, unique=True, verbose_name='product attribute name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retail_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99'}}, help_text='format: max price 9999.99', max_digits=6, verbose_name='recommended retail price')),
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99'}}, help_text='format: max price 9999.99', max_digits=6, verbose_name='recommended retail price')),
                ('sale_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99'}}, help_text='format: max price 9999.99', max_digits=6, verbose_name='recommended retail price')),
                ('weight', models.FloatField(verbose_name='product weight')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='format: Y-m-d H:M:S', verbose_name='date sub-product was created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.IntegerField(default=0, help_text='format: required, default-0', verbose_name='units/quantity of stock')),
                ('units_sold', models.IntegerField(default=0, help_text='format: required, default-0', verbose_name='units/quantity sold to date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='format: Y-m-d H:M:S', verbose_name='date image was created')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='format: Y-m-d H:M:S', verbose_name='date image last updated')),
